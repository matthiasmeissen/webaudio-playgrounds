...
(async () => {
    ...
    document.addEventListener("mousemove", (e) => {
        ...
        const speed1 = (mapNormalizedToRange($mouseX, 0.1, 1));
        const speed2 = (mapNormalizedToRange($mouseY, 0, 1));
    
        faustNode.setParamValue("/sound/Slider", speed1);
        faustNode.setParamValue("/sound/Shift", speed2);
    }
    );
...
function creatRandomNotes(faustNode, n) {
    for(let i = 0; i < 4; i++) {
        ...
        faustNode.setParamValue(`/sound/Note_${i}`, note);

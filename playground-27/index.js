...
document.addEventListener("keydown", (e) => {
    if (e.key == "1") {
        faustNode.setParamValue("/sound/Waveform", 0);
    } else if (e.key == "2") {
        faustNode.setParamValue("/sound/Waveform", 1);
    } else if (e.key == "3") {
        faustNode.setParamValue("/sound/Waveform", 2);
    } else if (e.key == "4") {
        faustNode.setParamValue("/sound/Waveform", 3);
    }
})

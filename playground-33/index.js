...
document.addEventListener("mousemove", (e) => {
    ...
    const mul = (mapNormalizedToRange(mouseX, 1.0, 4.0));
    const steps = (mapNormalizedToRange(mouseY, 1.0, 8.0));

    faustNode.setParamValue("/sound/Multiplier", mul);
    faustNode.setParamValue("/sound/Steps", steps);
});

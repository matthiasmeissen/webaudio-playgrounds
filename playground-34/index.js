...
document.addEventListener("mousemove", (e) => {
    ...
    const slices = (mapNormalizedToRange(mouseX, 1.0, 32.0));
    const offset = (mapNormalizedToRange(mouseY, 0.0, 1.0));

    faustNode.setParamValue("/sound/Slices", slices);
    faustNode.setParamValue("/sound/Offset", offset);
});

...
document.addEventListener("mousemove", (e) => {
    ...
    const steps = (mapNormalizedToRange(mouseX, 1, 16));
    const shift = (mapNormalizedToRange(mouseY, 0.0, 1.0));

    faustNode.setParamValue("/sound/Steps_1", steps);
    faustNode.setParamValue("/sound/Shift_1", shift);
});

...
document.addEventListener("mousemove", (e) => {
    ...
    const mul1 = (mapNormalizedToRange(mouseX, 0.25, 4.0));
    const mul2 = (mapNormalizedToRange(mouseY, 0.25, 4.0));

    faustNode.setParamValue("/sound/Multiply_1", mul1);
    faustNode.setParamValue("/sound/Multiply_2", mul2);
});

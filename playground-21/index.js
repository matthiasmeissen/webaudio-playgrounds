...
(async () => {
    ...
    document.addEventListener("mousemove", (e) => {
        ...
        faustNode.setParamValue("/Voice_1/Multiplier_1", speed1);
        faustNode.setParamValue("/Voice_1/Modulator_Index", speed2);
    }
    );
...
for(let i = 0; i < 4; i++) {
    ...
    faustNode.setParamValue(`/Voice_${n}/Step_${i}`, note);
